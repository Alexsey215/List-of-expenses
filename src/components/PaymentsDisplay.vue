<template>
  <div class="payments-display">
    ...
    <div class="payments-display-list" v-for="item in list" :key="item.id">
      ...
      <span class="payments-display-list-item" :class="'list-date-'+item.id">{{ item.date }}</span>
      <span class="payments-display-list-item" :class="'list-category-'+item.id">{{ item.category }}</span>
      <span class="payments-display-list-item" :class="'list-value-'+item.id">{{ item.value }}</span>
