<template>
  <div>
    <input name = "date1" placeholder="Date" v-model="date" class="wrapper-form-input" />
    <input name = "category1" placeholder="Category" v-model.trim="category" class="wrapper-form-input" />
    <input
      name = "value1"
      placeholder="Value"
      type="number"
